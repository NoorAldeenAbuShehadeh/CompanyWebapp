...
const ServicesContainer = lazy(() =>
  import("../Pages/Services/ServicesContainer")
);
...
export const routes = [
  ...
  {
    path: rootPath + "/RegisterAndLogin",
    title: routeNames.RegisterAndLogin,
    component: <RegisterAndLogin />,
  },
  {
    path: rootPath + "/ContactUs",
